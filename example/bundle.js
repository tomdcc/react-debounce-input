...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Controllable = __webpack_require__(155);
	
	var _Controllable2 = _interopRequireDefault(_Controllable);
	
	var _Customizable = __webpack_require__(162);
	
	var _Customizable2 = _interopRequireDefault(_Customizable);
	
	var _UndoRedo = __webpack_require__(163);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Customizable2.default, null)
	      ),
	      _react2.default.createElement(
	        'section',
	        { style: style.section },
	        _react2.default.createElement(
	          'h2',
	          null,
	          'Example 2. Controllabe'
	        ),
	        _react2.default.createElement(_Controllable2.default, null)
	      ),
	      _react2.default.createElement(
	        'section',
	        { style: style.section },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DebounceInput = __webpack_require__(156);
	...
	var Controllable = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var debouncedValue = _state.debouncedValue;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { style: style.label },
	          'Contollable input:',
	          _react2.default.createElement('input', { style: style.input,
	            type: 'text',
	            value: value,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { style: style.label },
	          'Debounced input:',
	          _react2.default.createElement(_DebounceInput2.default, { style: style.input,
	            value: value,
	            minLength: 2,
	            debounceTimeout: 500,
	            onChange: function onChange(e) {
	              return _this.setState({ value: e.target.value, debouncedValue: e.target.value });
	            } }),
	          debouncedValue
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactComponentWithPureRenderMixin = __webpack_require__(159);
	...
	var DebounceInput = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props2, ['onChange', 'value', 'minLength', 'debounceTimeout', 'forceNotifyByEnter', 'forceNotifyOnBlur']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Customizable = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var infinite = _state.infinite;
	    var debounceTimeout = _state.debounceTimeout;
	    var forceNotifyByEnter = _state.forceNotifyByEnter;
	    var forceNotifyOnBlur = _state.forceNotifyOnBlur;
	    var value = _state.value;
	    var key = _state.key;
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { style: style.input,
	            ...
	            onChange: function onChange(e) {
	              return _this.setState({ minLength: parseInt(e.target.value, 10) });
	            } }),
	          minLength
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { style: style.input,
	            ...
	            onChange: function onChange(e) {
	              return _this.setState({ debounceTimeout: parseInt(e.target.value, 10) });
	            } }),
	          debounceTimeout
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { style: style.input,
	            ...
	            checked: infinite,
	            onChange: function onChange(e) {
	              return _this.setState({ infinite: e.target.checked });
	            } })
	        )
	      ),
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { style: style.input,
	            ...
	            onChange: function onChange(e) {
	              return _this.setState({ forceNotifyByEnter: e.target.checked });
	            } })
	        ),
	        _react2.default.createElement(
	          'label',
	          ...
	          _react2.default.createElement('input', { style: style.input,
	            ...
	            onChange: function onChange(e) {
	              return _this.setState({ forceNotifyOnBlur: e.target.checked });
	            } })
	        )
	      ),
	      _react2.default.createElement(_DebounceInput2.default, {
	        ...
	        onKeyDown: function onKeyDown(e) {
	          return _this.setState({ key: e.key });
	        } }),
	      _react2.default.createElement(
	        'p',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var item = { marginRight: 10 };
	
	var UndoRedo = _react2.default.createClass({
	  ...
	  setValueFromHistory: function setValueFromHistory(index) {
	  ...
	  render: function render() {
	    ...
	    var history = this.state.history.map(function (value, key) {
	      return _react2.default.createElement(
	        'span',
	        { style: item, key: key },
	        key === _this.state.historyIndex ? _react2.default.createElement(
	          'b',
	          null,
	          '"',
	          value,
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { style: style.input, onClick: this.undo },
	            'Undo'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { style: style.input, onClick: this.redo },
	            'Redo'
	          )
	        )
	      ),
